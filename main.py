...
class FigurineProPlugin(Star):
    ...
    def _build_persona_prompt(self, scene_prompt: str = "", extra_request: str = "") -> str:
        ...
        prompt_parts = [
            ...
            "REALISTIC HAIR RECONSTRUCTION RULE: Rebuild the hairstyle as biologically plausible human hair instead of copying individual anime line-art strands. Hair must visibly grow from a natural scalp and hairline, with realistic roots, irregular strand grouping, varied strand thickness, fine baby hairs, subtle flyaways, natural gravity, weight, volume, translucency at the edges, and soft photographic highlights.",
            "The bangs must be separated into multiple naturally overlapping locks with small irregular gaps and believable depth. Never render the bangs as one solid curtain, a rigid shell, a helmet, or a pasted-on wig shape.",
            "Use a slightly darker natural root tone where appropriate, and implement the coral-pink tips as a believable professional hair-dye gradient with gradual color transition along real strands, never as a flat painted block or texture map.",
            ...
            "HAIR NEGATIVE RULE: No wig-like hair, synthetic fiber texture, plastic hair, helmet hair, solid curtain bangs, pasted-on hairstyle, molded grooves, engraved strand patterns, anime line-art strands, cel-shaded hair, excessive strand repetition, or different lighting and sharpness between hair and skin.",
