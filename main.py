...
class FigurineProPlugin(Star):
    ...
    def _build_persona_prompt(self, scene_prompt: str = "", extra_request: str = "") -> str:
        ...
        prompt_parts = [
            ...
            "REALISTIC HAIR MASSING RULE: Rebuild the hairstyle as coherent, soft, naturally blended human hair masses rather than individually traced strands. Prioritize broad smooth locks, continuous tonal transitions, unified volume, natural gravity, and soft photographic highlights. The majority of the hair surface must read as calm blended shapes with gentle detail, not as hundreds of visible parallel lines.",
            "Fine individual hairs may appear only sparingly at the outer silhouette, hairline, and a few naturally loose flyaways. Keep the main hair body softly grouped and visually smooth at normal portrait distance.",
            "The bangs must form several broad, softly overlapping sections with subtle depth and a few natural gaps. Avoid both a single rigid curtain and excessive separation into many thin strips.",
            "Use a subtle natural root transition where appropriate, and implement the coral-pink tips as a smooth professional dye gradient across broad locks. The gradient must be softly blended and must not follow or outline every individual strand.",
            "At every contact area between hair and forehead, temples, ears, cheeks, neck, clothing, and shoulders, include physically consistent contact shadows, ambient occlusion, soft reflected skin color, and natural strand overlap. The hair must feel attached to and integrated with the same real human head and skin.",
            "Hair and skin must share exactly the same light direction, color temperature, exposure, white balance, depth of field, camera sharpness, noise level, and photographic post-processing. No mismatch in rendering style, clarity, texture frequency, or lighting between the face and hair.",
            "HAIR NEGATIVE RULE: No wig-like hair, synthetic fiber texture, plastic hair, helmet hair, solid curtain bangs, pasted-on hairstyle, molded grooves, engraved strand patterns, anime line-art strands, cel-shaded hair, comb-tooth hair, noodle-like strands, dense parallel lines, uniformly separated strands, excessive micro-strand detail, or different lighting and sharpness between hair and skin.",
            ...
            "Natural pose and expression, candid moment, professional photography, clean natural skin, softly grouped natural hair, smooth continuous color gradients, high quality.",
